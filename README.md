...
## Self-hosted HTTPS static content in three steps
    ...
    curl -sL https://github.com/memmaker/ngman/releases/download/v1.0.6/setup.sh | sudo bash -s <your-acme-mail>
...
## Self-hosted HTTPS reverse proxy in three steps
    ...
    1. Setup a Web Server
    curl -sL https://github.com/memmaker/ngman/v1.0.6/download/latest/setup.sh | sudo bash -s <your-acme-mail>
